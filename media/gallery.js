document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('Videos array loaded:', videos.length, 'videos found');
    ...
    console.log('Videos shuffled:', shuffledVideos.length, 'videos');
    ...
    function createGalleryItem(video, index) {
        ...
        thumbnail.onload = () => {
            console.log(`Successfully loaded thumbnail: ${video.thumbnail}`);
    ...
    function checkAllVideosLoaded() {
        if (videosLoaded >= shuffledVideos.length) {
            console.log('All videos loaded, hiding loading indicator');
